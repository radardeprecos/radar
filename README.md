...
*   **Links de Afiliados:** Integrado com o `matt_tool=radar041-20` para rastreamento de comissões.
...
3.  **Certifique-se de que o `custom_affiliate_url` de cada produto contenha `matt_tool=radar041-20` para garantir suas comissões.**

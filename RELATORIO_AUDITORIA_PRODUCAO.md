...
* **O problema:** O arquivo `ads.txt` foi publicado em `https://radardeprecos.github.io/radar/ads.txt`. No entanto, a especificação oficial do Google AdSense exige que o arquivo seja acessível **estritamente na raiz do domínio de segundo nível**: `https://radardeprecos.github.io/radar/ads.txt`.

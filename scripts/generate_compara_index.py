...
RADAR_INDEX_FILE = DATA_DIR / "precos-index.json"
...
def generate_compara_index_data():
    index_data = {
...
if __name__ == "__main__":
    data = generate_compara_index_data()
    with open(RADAR_INDEX_FILE, "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=2)
    print(f"Dados do Radar de Preços Index™ gerados em {RADAR_INDEX_FILE}")
